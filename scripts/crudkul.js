  ...
  onGetReviews((querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      revCard.innerHTML += `<div class="card card-body mt-2 
              ...
              Experiencia en general: ${review.experience}</br>
              Cuidado de los suelos: ${review.ground}</br>
              Cuidado de la vida silvestre: ${review.life}</br>
              Uso responsable de energía: ${review.energy}</br>
              Cuidado del ruido: ${review.noise} </br>
              Apoyo a locales: ${review.people}</br>
              </p>
              <div>
